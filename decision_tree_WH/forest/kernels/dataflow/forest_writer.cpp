...
void kernel_main() {
    ...
    uint32_t ublock_size_bytes = get_tile_size(cb_id_out)*n_samples;
    uint32_t l1_read_addr = get_read_ptr(cb_id_out);
    DPRINT << "Hello, Master, I am running in writer1." << ENDL();
    ...
    DPRINT << "Hello, Master, I am running in writer0." << ENDL();
}
